...
def main():
    ...
    data = load_json('./race_json/intersentence_race_100.json') #the name of the raw json file we want to test
    ...
    with open('race_inter_100.json', 'w', encoding='utf-8') as outfile: #name of the output json file
